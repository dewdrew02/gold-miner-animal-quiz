...
const AudioSynth = {
    ...
    playShootSound() {
        try {
            ...
            console.warn("Failed to play shoot sound:", e);
        }
    },
    ...
    playGrabSound() {
        try {
            ...
            console.warn("Failed to play grab sound:", e);
        }
    },
    ...
    playReelSound(speed) {
        try {
            ...
            console.warn("Failed to play reel sound:", e);
        }
    },
    ...
    playGoldSound(weight) {
        try {
            ...
            console.warn("Failed to play gold sound:", e);
        }
    },
    ...
    playDiamondSound() {
        try {
            ...
            console.warn("Failed to play diamond sound:", e);
        }
    },
    ...
    playBagSound() {
        try {
            ...
            console.warn("Failed to play bag sound:", e);
        }
    },
    ...
    playDynamiteSound() {
        try {
            ...
            console.warn("Failed to play dynamite sound:", e);
        }
    },
    ...
    playBuySound() {
        try {
            ...
            console.warn("Failed to play buy sound:", e);
        }
    },
